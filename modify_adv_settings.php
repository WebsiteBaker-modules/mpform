...
$sCaptchaType = $database->get_one('SELECT `captcha_type` FROM         `'.TABLE_PREFIX.'mod_captcha_control`');
...
$tpl->set_var(
        array(
                ...
                'CAPTCHA_TYPE_IMAGE'        => $sCaptchaImgSrc != '' ? '<img style="border:1px dotted #ccc; " alt="captcha_example" id="captcha_example" src="'.$sCaptchaImgSrc.'" />' : '',
